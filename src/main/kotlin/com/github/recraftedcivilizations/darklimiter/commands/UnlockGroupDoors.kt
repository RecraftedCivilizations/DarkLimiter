...
class UnlockGroupDoors(private val doorLocker: DoorLocker, private val doorSelector: DoorSelector) : CommandExecutor{
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        when(doorLocker.isLocked(upperHalf)){
            ...
            LockedFor.Player -> {
                sender.sendMessage("${ChatColor.RED}This door is locked for a player, use the forceunlock command instead")
            }
        }
        return true
    }
